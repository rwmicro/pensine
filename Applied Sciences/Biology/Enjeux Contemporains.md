---
title: "Enjeux Contemporains en Biologie"
...
```mermaid
flowchart TD
    A[Activité humaine] --> B[Destruction habitats]
    A --> C[Changement climatique]
    A --> D[Pollution]
    A --> E[Espèces invasives]
    A --> F[Surexploitation]
    B --> X[Effondrement de la biodiversité]
    C --> X
    D --> X
    E --> X
    F --> X
