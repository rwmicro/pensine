---
title: "Positivisme Logique"
domain: "Social Sciences"
subdomain: "Philosophy > Courants & Écoles"
tags: [sciences-sociales, philosophie, positivisme, cercle-de-vienne, science]
date: "2026-08-08"
---

# Positivisme Logique (1920-1940)
...
Critère central proposé pour distinguer le sens du non-sens : **une proposition n'a de signification cognitive que si elle est vérifiable, au moins en principe, par l'expérience — ou si elle est analytiquement vraie (tautologie logique ou mathématique)**.

```
  Toute proposition significative appartient
  à l'une de ces deux catégories :

  ANALYTIQUE                       SYNTHÉTIQUE VÉRIFIABLE
  Vraie par la seule logique         Vraie ou fausse selon
  ou la définition des termes         l'observation empirique
  "Tous les célibataires             "L'eau bout à 100°C
   sont non mariés"                   au niveau de la mer"
  (mathématiques, logique)           (sciences empiriques)

  Toute proposition qui n'appartient à AUCUNE des deux
  catégories est DÉNUÉE DE SENS (sinnlos) — pas fausse,
  littéralement vide de contenu cognitif.
```

**Conséquence radicale** : la métaphysique traditionnelle ("l'Absolu est spirituel", "le Néant néantit"), l'éthique normative ("le meurtre est mal" au sens d'un fait objectif) et la théologie ne sont pas de fausses affirmations sur le monde — elles ne sont **pas des affirmations du tout**, au même titre qu'une suite de mots grammaticalement correcte mais vide de sens empirique ou logique. Rudolf Carnap se livre à une démolition méthodique de la métaphysique heideggérienne dans son article "Le dépassement de la métaphysique par l'analyse logique du langage" (1932), prenant pour cible la formule "le Néant néantit" (*das Nichts nichtet*) comme exemple paradigmatique de pseudo-proposition.

## L'émotivisme en éthique
...
```
  "Une proposition n'a de sens que si elle est
   vérifiable empiriquement ou analytique."

  Cette proposition elle-même :
  - N'est pas vérifiable empiriquement
    (aucune observation ne peut la confirmer)
  - N'est pas une tautologie analytique
    (elle n'est pas vraie par simple définition
     des termes)

  → Selon son PROPRE critère, le principe de
...
Bien que le programme central (le critère de vérification) se soit effondré sous ses propres critères, le positivisme logique laisse un héritage durable :
- **L'exigence de clarté conceptuelle et de rigueur argumentative** qui caractérise toute la philosophie analytique ultérieure — voir [[Philosophie Analytique]]
- **La philosophie des sciences** comme sous-discipline autonome et rigoureuse, dont Popper, Kuhn et Feyerabend seront les héritiers critiques
- **La logique formelle** appliquée systématiquement à l'analyse philosophique, prolongeant Frege et Russell
- Un repoussoir méthodologique constant : la plupart des développements ultérieurs de la philosophie du langage et des sciences (Wittgenstein tardif, Quine, Kuhn) se construisent explicitement contre les excès positivistes, tout en conservant l'exigence de rigueur qu'ils avaient portée

## Citations

> "Les énoncés métaphysiques sont dénués de sens." (thèse centrale du Cercle de Vienne)

> "Sur ce dont on ne peut parler, il faut garder le silence." (Wittgenstein, *Tractatus*, souvent lu — et retourné contre ses propres implications — comme la formule programmatique du positivisme logique)
