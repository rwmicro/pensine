---
title: "Frise de la Philosophie Occidentale"
domain: "Social Sciences"
subdomain: "Philosophy > Culture G > Frises Chronologiques"
tags: [philosophie, histoire, chronologie, culture-générale]
date: "2026-04-12"
---
...
```mermaid
timeline
    title Philosophie Occidentale — Grandes Périodes
    section Antiquité grecque
        Présocratiques : Héraclite : Parménide : Démocrite
        Âge d'Or : Socrate : Platon : Aristote
        Hellénistique : Stoïcisme : Épicurisme : Scepticisme
    section Moyen Âge
        Patristique : Augustin : Boèce
        Scolastique : Avicenne : Thomas d'Aquin : Occam
    section XVIIe – XVIIIe siècle
        Rationalisme : Descartes : Spinoza : Leibniz
        Empirisme : Locke : Berkeley : Hume
        Lumières : Rousseau : Voltaire : Kant
    section XIXe siècle
        Post-kantien : Hegel : Schopenhauer
        Ruptures : Marx : Kierkegaard : Nietzsche
    section XXe siècle
        Phénoménologie : Husserl : Heidegger : Sartre : Beauvoir : Camus
        Analytique : Russell : Wittgenstein : Popper : Rawls
        Postmoderne : Foucault : Derrida : Deleuze : Baudrillard
    section XXIe siècle
