---
title: "Méthodes et Ressources pour Apprendre les Langues"
domain: "Social Sciences"
subdomain: "Languages - Dialects"
tags: [sciences-sociales, langues, methodes, apprentissage, SLA]
date: "2026-03-27"
---
...
```mermaid
flowchart TD
    A[1. Phonologie et sons] --> B[2. Phrases de survie - 50 phrases]
    B --> C[3. Registres formels/informels]
    C --> D[4. Les 500 mots les plus fréquents]
    D --> E[5. Grammaire de base - structure de phrase]
    E --> F[6. Vocabulaire thématique - 2000 mots]
    F --> G[7. Input massif - séries, podcasts, lectures]
    G --> H[8. Production - conversation, écriture]
```
