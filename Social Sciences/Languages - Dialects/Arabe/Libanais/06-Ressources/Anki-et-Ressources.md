---
title: "Anki et Ressources — Arabe Libanais"
...
```mermaid
flowchart TD
    A[Semaines 1-4 Phonologie + 200 mots fréquents Deck Anki + Hiba Najem YouTube] --> B[Semaines 5-12\nGrammaire essentielle\nManuel Aldrich + phrases contextualisées]
    B --> C[Mois 3-6\nInput massif\nSéries libanaises + podcasts + échanges natifs]
    C --> D[Mois 6+\nMaintien SRS + immersion\nConversation régulière avec natifs]
```
...
| Audio natif obligatoire | Les sons emphatiques et le ayn (![ع](Social%20Sciences/Languages%20-%20Dialects/Arabe/Libanais/06-Ressources/audio/ar-lb_male_17771ee07751.mp3)) s'acquièrent uniquement par imitation |
